...
import static com.example.cs.groupassignment2.models.Item.items;


    public class CaptionedImagesAdapter
            extends RecyclerView.Adapter<com.example.cs.groupassignment2.CaptionedImagesAdapter.ViewHolder>  {
